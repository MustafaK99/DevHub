...
const Project = () => {
    ...
    return (
        <div>
            ...
            {location.state.start_time != null ? <h1>location.state.start_time</h1> : <h1>No start_time</h1>}
            {location.state.end_time != null ? <h1>location.state.end_time</h1> : <h1>No end_time</h1>}
