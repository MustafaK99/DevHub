...
const Pagination = ({ pages, setCurrentPage, currentProjects, sortedProjects }) => {
    ...
    return (
        <div className="clearfix">
            <div className="hint-text">Showing <b>{currentProjects.length}</b> out of <b>{sortedProjects.length}</b> entries</div>
